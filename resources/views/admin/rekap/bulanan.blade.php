...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <p class="text-muted mb-0">
            Rekap absensi karyawan berdasarkan bulan dan PT / Proyek
        </p>
    </div>
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <form
            action="{{ route('admin.rekap.bulanan') }}"
            method="GET"
        >
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    ...
                    <a
                        href="{{ route('admin.rekap.bulanan') }}"
                        class="btn btn-secondary"
                    >
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <a
                href="{{ route('admin.rekap.export.excel', array_merge(request()->query(), ['jenis' => 'bulanan'])) }}"
            ...
            <a
                href="{{ route('admin.rekap.export.pdf', array_merge(request()->query(), ['jenis' => 'bulanan'])) }}"
                    ...
                    @empty
                        ...
                        <tr>
                            ...
                            >
                                ...
                                <p class="text-muted mb-0">
                                    Tidak ada absensi pada bulan dan PT / Proyek yang dipilih.
                                </p>
